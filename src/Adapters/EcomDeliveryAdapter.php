...
/**
 * Adapter for the E-COM Delivery API.
 *
 * Auth : Bearer <token>
 * Base : https://ecom-dz.net
 */
final class EcomDeliveryAdapter extends AbstractAdapter
{
    ...
    public function __construct(
        ...
        parent::__construct(
            baseUrl: Provider::ECOM_DELIVERY->baseUrl(),
            defaultHeaders: [
        ...
        $this->providerEnum = Provider::ECOM_DELIVERY;
    }
    ...
    {
        try {
            $this->get('api/v1/orders', ['per_page' => 1]);
    ...
    {
        try {
            $response = $this->get("api/v1/orders/{$trackingNumber}");
    ...
    {
        $response = $this->get("api/v1/orders/{$trackingNumber}/label");
    ...
    {
        $this->post("api/v1/orders/{$trackingNumber}/cancel");
